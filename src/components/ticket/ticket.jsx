    ...
    >
      ...
      <dl className={classes.ticket__route}>
        <div>
          ...
          ${addZero(backWayDestinationTime.getUTCHours())}:${addZero(backWayDestinationTime.getUTCMinutes())}`}
          </dd>
        </div>
        <div>
          <dt>В пути</dt>
...
Ticket.propTypes = {
  ticket: PropTypes.objectOf(
    PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.arrayOf(PropTypes.objectOf)])
  ),
};
